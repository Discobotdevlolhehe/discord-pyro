declare module 'discord-pyro' {
    import {
        BufferResolvable, Client, ClientOptions, Collection,
        Message, AttachmentBuilder, EmbedBuilder,
        MessageEditOptions, MessageCreateOptions, MessagePayload,
        User, UserResolvable, GuildMember,
        Channel, Role, Emoji, Guild, ReplyOptions,
    ...
    export class PyroClient extends Client {
        public constructor(options?: PyroOptions & ClientOptions);
        public constructor(options: PyroOptions, clientOptions: ClientOptions);
    ...
    export class PyroHandler extends EventEmitter {
        public constructor(client: PyroClient, options: PyroHandlerOptions);

        public automateCategories: boolean;
        public extensions: Set<string>;
        public categories: Collection<string, Category<string, PyroModule>>;
        public classToHandle: Function;
        public client: PyroClient;
        public directory: string;
        public loadFilter: LoadPredicate;
        public modules: Collection<string, PyroModule>;

        public deregister(mod: PyroModule): void;
        public findCategory(name: string): Category<string, PyroModule>;
        public load(thing: string | Function, isReload?: boolean): PyroModule;
        public loadAll(directory?: string, filter?: LoadPredicate): this;
        public register(mod: PyroModule, filepath?: string): void;
        public reload(id: string): PyroModule;
        public reloadAll(): this;
        public remove(id: string): PyroModule;
        public removeAll(): this;
        public on(event: 'remove', listener: (mod: PyroModule) => any): this;
        public on(event: 'load', listener: (mod: PyroModule, isReload: boolean) => any): this;

        public static readdirRecursive(directory: string): string[];
    }

    export class PyroModule {
        public constructor(id: string, options?: PyroModuleOptions);

        public category: Category<string, PyroModule>;
        public categoryID: string;
        public client: PyroClient;
        public filepath: string;
        public handler: PyroHandler;
        public id: string;
    ...
    export class Argument {
        ...
        public readonly client: PyroClient;
        ...
        public otherwise?: string | MessageCreateOptions | OtherwiseContentSupplier;
    ...
    export class ClientUtil {
        public constructor(client: PyroClient);

        public readonly client: PyroClient;

        public attachment(file: BufferResolvable | Stream, name?: string): AttachmentBuilder;
        ...
        public embed(data?: object): EmbedBuilder;
    ...
    export class Command extends PyroModule {
        ...
        public client: PyroClient;
        public clientPermissionsBitField: PermissionResolvable | PermissionResolvable[] | MissingPermissionSupplier;
        ...
        public ignorePermissionsBitField?: Snowflake | Snowflake[] | IgnoreCheckPredicate;
        public ownerOnly: boolean;
        public prefix?: string | string[] | PrefixSupplier;
        public ratelimit: number;
        public regex: RegExp | RegexSupplier;
        public typing: boolean;
        public userPermissionsBitField: PermissionResolvable | PermissionResolvable[] | MissingPermissionSupplier;
    ...
    export class CommandHandler extends PyroHandler {
        public constructor(client: PyroClient, options: CommandHandlerOptions);
        ...
        public on(event: 'missingPermissionsBitField', listener: (message: Message, command: Command, type: 'client' | 'user', missing?: any) => any): this;
    }
    ...
    export class CommandUtil {
        ...
        public reply(options: string | MessagePayload | ReplyOptions): Promise<Message>;
        public send(options: string | MessagePayload | MessageCreateOptions): Promise<Message>;
        public sendNew(options: string | MessagePayload | MessageCreateOptions): Promise<Message>;

        public setEditable(state: boolean): this;
        public setLastResponse(message: Message | Message[]): Message;

        public static transformOptions(options?: string | MessageCreateOptions): MessageCreateOptions;
    }
    ...
    export class Inhibitor extends PyroModule {
    ...
    export class InhibitorHandler extends PyroHandler {
        public constructor(client: PyroClient, options: PyroHandlerOptions);
    ...
    export class Listener extends PyroModule {
    ...
    export class ListenerHandler extends PyroHandler {
        public constructor(client: PyroClient, options: PyroHandlerOptions);
    ...
    export interface PyroHandlerOptions {
    ...
    export interface PyroModuleOptions {
        category?: string;
    }

    export interface PyroOptions {
        ownerID?: Snowflake | Snowflake[];
    }

    export interface DefaultArgumentOptions {
        prompt?: ArgumentPromptOptions;
        otherwise?: string | MessageCreateOptions | OtherwiseContentSupplier;
    ...
    export interface ArgumentPromptOptions {
        breakout?: boolean;
        cancel?: string | MessageCreateOptions | PromptContentSupplier;
        cancelWord?: string;
        ended?: string | MessageCreateOptions | PromptContentSupplier;
        infinite?: boolean;
        limit?: number;
        ...
        optional?: boolean;
        retries?: number;
        retry?: string | MessageCreateOptions | PromptContentSupplier;
        start?: string | MessageCreateOptions | PromptContentSupplier;
        stopWord?: string;
        time?: number;
        timeout?: string | MessageCreateOptions | PromptContentSupplier;
    }
    ...
    export interface CommandOptions extends PyroModuleOptions {
        aliases?: string[];
        args?: ArgumentOptions[] | ArgumentGenerator;
        argumentDefaults?: DefaultArgumentOptions;
        before?: BeforeAction;
        channel?: 'guild' | 'dm';
        clientPermissionsBitField?: PermissionResolvable | PermissionResolvable[] | MissingPermissionSupplier;
        ...
        ignorePermissionsBitField?: Snowflake | Snowflake[] | IgnoreCheckPredicate;
        ...
        separator?: string;
        typing?: boolean;
        userPermissionsBitField?: PermissionResolvable | PermissionResolvable[] | MissingPermissionSupplier;
        quoted?: boolean;
    }

    export interface CommandHandlerOptions extends PyroHandlerOptions {
    ...
    export interface InhibitorOptions extends PyroModuleOptions {
        reason?: string;
        type?: string;
        priority?: number;
    }

    export interface ListenerOptions extends PyroModuleOptions {
    ...
    export type OtherwiseContentModifier = (message: Message, text: string, data: FailureData)
        => string | MessageCreateOptions | Promise<string | MessageCreateOptions>;
    ...
    export const Constants: {
        ...
        CommandHandlerEvents: {
            ...
            MISSING_PERMISSIONS: 'missingPermissionsBitField';
            COOLDOWN: 'cooldown';
            IN_PROMPT: 'inPrompt';
            ERROR: 'error';
        };
